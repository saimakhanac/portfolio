      ...
      <section className="py-10">
        <div className="flex flex-wrap w-full justify-around items-center">
          ...
          <div className="flex gap-6">
            ...
            <div className="flex items-center gap-4 my-4">
              <a href="https://github.com/saimakhanac" className="text-primary">
                <svg
                  className="w-6 h-6"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 640"
          ...
          {/* 3 start here */}
          <div className="grid grid-cols-3 md:my-0 my-3">
            {footerLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm mx-4 font-semibold tracking-tight text-foreground transition-colors relative group"
              >
                {link.label}
              </Link>
            ))}
